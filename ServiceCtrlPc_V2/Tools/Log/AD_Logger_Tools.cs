...
namespace Scheduler.Tools.Log
{
    class AD_Logger_Tools
    {
        ...
        public static void Log_Write(string Log_GUID, string Log_Evt, string Log_Message, bool With_Log_STDOUT)
        {
            ...
            string _Log_Entete_Begin = CtrlPc_Service.guid + ";" + Environment.GetEnvironmentVariable("COMPUTERNAME") + ";" + CtrlPc_Service.Version_Service + ";" + _Log_Src + ";" + DateTime.UtcNow.ToString();
